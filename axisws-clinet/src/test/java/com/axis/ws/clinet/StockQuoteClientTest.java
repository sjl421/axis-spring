...
import com.axis.ws.axisws.impl.SimpleServiceStub;
import com.axis.ws.axisws.impl.SimpleServiceStub.GetCityResponse;
import com.axis.ws.axisws.impl.SimpleServiceStub.HelloService;
import com.axis.ws.axisws.impl.SimpleServiceStub.HelloServiceResponse;
...
public class StockQuoteClientTest {
	/** 
	  ...
	  public static void testRPCClient() {  
	    try {  
	      // axis2 服务端  
	      String url = "http://localhost:8080/axisws/services/SimpleService?wsdl";  
	  ...
	  */  
	  ...
	  public void testCodeClient() {  
	    try {  
	      String url = "http://localhost:8080/axisws/services/SimpleService";  
	      SimpleServiceStub stub = new SimpleServiceStub(url); 
	      HelloService s = new SimpleServiceStub.HelloService();
	      s.setMsg("ayayayayayyayayayyay");
	      HelloServiceResponse response = stub.helloService(s);
	      System.out.println(response.get_return());  
	      
	      SimpleServiceStub stub2 = new SimpleServiceStub(url); 
	      GetCityResponse response2 = stub2.getCity(new SimpleServiceStub.GetCity());
	      System.out.println(Arrays.toString(response2.get_return()));  
